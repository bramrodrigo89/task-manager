...
@app.route('/new_task')
def new_task():
    return render_template("addtask.html", categories=mongo.db.categories.find(), methods="POST")
...
def edit_task(task_id):
    ...
    return render_template("edittask.html", categories=all_categories, task=the_task)
